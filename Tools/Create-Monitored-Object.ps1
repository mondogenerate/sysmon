$TenantID =    (Get-AzContext).Tenant.Id  #"xxxxxxxxx-xxxx-xxx"  #Your Tenant ID
$SubscriptionID = (Get-AzContext).Subscription.Id # "xxxxxx-xxxx-xxxxx" #Your Subscription ID
$ResourceGroup = "SC-200" #Your resroucegroup
